DO $$ BEGIN
 CREATE TYPE "public"."case_status" AS ENUM('draft', 'ready', 'approved');
EXCEPTION
...
--> statement-breakpoint
ALTER TABLE "test_cases" ADD COLUMN IF NOT EXISTS "status" "case_status" DEFAULT 'draft' NOT NULL;--> statement-breakpoint
ALTER TABLE "test_cases" ADD COLUMN IF NOT EXISTS "approved_by_id" uuid;--> statement-breakpoint
ALTER TABLE "test_cases" ADD COLUMN IF NOT EXISTS "approved_at" timestamp;--> statement-breakpoint
DO $$ BEGIN
