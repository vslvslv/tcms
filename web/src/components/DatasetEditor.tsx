  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-3">
        ...
        <h3 className="text-base font-semibold text-slate-900">{dataset?.name ?? "Dataset"}</h3>
      </div>
      ...
      {/* Column management */}
      <Card className="p-4">
        <h4 className="mb-2 text-sm font-medium text-slate-700">Columns</h4>
        <div className="flex flex-wrap items-center gap-2">
          ...
          <form onSubmit={addColumn} className="flex items-center gap-2">
            <input
              ...
              className="w-36 rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-sm focus:border-blue-500 focus:outline-none"
            />
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50">
                  ...
                  {columns.map((col) => (
                    <th key={col.id} className="px-3 py-2 text-left text-xs font-semibold text-slate-500">
                      {col.name}
                    </th>
                  ))}
                </tr>
